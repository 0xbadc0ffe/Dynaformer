...
from surrogate.models.dynaformer import Dynaformer
...
def main():
    ...
    val_dir = st.text_input("Insert path to the dataset (Something like dataset/YYYY-MM-DD/HH-MM-SS/data", "data/variable_currents/2022-04-27/14-58-12/data")
